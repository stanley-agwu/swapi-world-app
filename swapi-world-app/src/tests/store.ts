  ...
  swapiApi: {
    queries: {
      'getPlanets("5")': {
        ...
        data: {
          count: 60,
          next: 'https://swapi.info/api/planets/?page=6',
          previous: 'https://swapi.info/api/planets/?page=4',
          results: [
            {
              name: 'Tund',
              rotation_period: '48',
    ...
    favorites: {
      ...
      starships: [
        ...
        },
        {
          ...
          pilots: ['https://swapi.info/api/people/10/', 'https://swapi.info/api/people/11/'],
          films: ['https://swapi.info/api/films/6/'],
        ...
        },
        {
          ...
          pilots: ['https://swapi.info/api/people/10/', 'https://swapi.info/api/people/35/'],
          films: ['https://swapi.info/api/films/6/'],
        ...
        },
        {
          ...
          MGLT: 'unknown',
          starship_class: 'starfighter',
          pilots: ['https://swapi.info/api/people/10/', 'https://swapi.info/api/people/79/'],
          films: ['https://swapi.info/api/films/6/'],
    ...
    planets: {
      planetList: [
        ...
        },
        {
          ...
          residents: ['https://swapi.info/api/people/14/', 'https://swapi.info/api/people/18/'],
          films: [],
        ...
        },
        {
          ...
          surface_water: '60',
          population: '45000000',
          residents: ['https://swapi.info/api/people/13/', 'https://swapi.info/api/people/80/'],
          films: ['https://swapi.info/api/films/6/'],
    ...
    people: {
      peopleList: [
        ...
        },
        {
          ...
          species: [],
          vehicles: ['https://swapi.info/api/vehicles/44/', 'https://swapi.info/api/vehicles/46/'],
          starships: [
            'https://swapi.info/api/starships/39/',
            'https://swapi.info/api/starships/59/',
            'https://swapi.info/api/starships/65/',
    ...
    starships: {
      starshipList: [
        ...
        },
        {
          ...
          MGLT: 'unknown',
          starship_class: 'Starfighter',
          pilots: ['https://swapi.info/api/people/10/', 'https://swapi.info/api/people/58/'],
